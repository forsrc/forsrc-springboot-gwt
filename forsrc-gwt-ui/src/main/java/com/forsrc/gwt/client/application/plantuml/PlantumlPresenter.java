...
public class PlantumlPresenter extends Presenter<PlantumlPresenter.MyView, PlantumlPresenter.MyProxy>
    ...
    @ProxyStandard
    @NameToken(NameTokens.PLANTUML)
    @NoGatekeeper
    interface MyProxy extends ProxyPlace<PlantumlPresenter> {
    }
